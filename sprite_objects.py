...
class Sprites:
    def __init__(self):
        ...
        self.list_of_objects = [
            ...
            SpriteObject(self.sprite_parameters['npc_soldier0'], (10, 5)),
        ]
...
class SpriteObject:
    def __init__(self, parameters, pos):
        ...
        self.damage_to_player = parameters['damage_to_player']
        # ---------------------
    ...
    def object_locate(self, player):
        ...
        if 0 <= fake_ray <= FAKE_RAYS_RANGE and self.distance_to_sprite > 30:
            ...
            if self.flag in {'door_h', 'door_v'}:
                ...
                if self.is_dead and self.is_dead != 'immortal' and self.hp < 1:
